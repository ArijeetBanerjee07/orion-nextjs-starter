...
export interface DecryptedTextProps extends Omit<React.HTMLAttributes<HTMLSpanElement>, 'onDrag' | 'onDragStart' | 'onDragEnd' | 'onAnimationStart' | 'onDragEnter' | 'onDragLeave' | 'onDragOver' | 'onDrop'> {
  text: string;
  speed?: number;
...
export default function DecryptedText({
  ...
  }, [animateOn, hasAnimated, triggerDecrypt, initialDelay]);
